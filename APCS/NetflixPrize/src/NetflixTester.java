...
public class NetflixTester {
	...
	public static final String baseFile = "testdata" + FileIO.fileSeparator + "1Ratings.csv";
	public static final String testFile = "testdata" + FileIO.fileSeparator + "1Tests.csv";
	...
	public static void main(String[] args) {
		...
		for (String line : testDataLines) {
			...
			System.out.println("Total diff: " + totalDifference);
